...
namespace Assignment_1
{
    class Program
    {
        public static string newDateOfLaunch { get; private set; }
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid role selected. Exiting the program.");
            }
        }
        ...
        static void ModifyData(List<Movie> movies)
        {
            ...
            if (movieToModify != null)
            {
                ...
                *//*if (DateTime.TryParse(Console.ReadLine(), out DateTime newDateOfLaunch))
                {*//*
                    movieToModify.DateOfLaunch = newDateOfLaunch;
              //  }
                *//*else
                {
            ...
            return new List<Movie>
        {
            ...
            new Movie("Romeo must Die", "Action", "2004/04/14", 100000),
            new Movie("Once upon a time in China", "Action", "2005/06/03", 100000),
            new Movie("Hungama", "Comedy", "2005/12/31", 50000),
            new Movie("Ace Ventura", "Comedy", "2001/08/23", 50000),
            new Movie("Manorama", "Drama", "2014/05/21", 75000)
        };
        }
    }
