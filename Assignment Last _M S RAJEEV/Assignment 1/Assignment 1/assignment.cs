...
namespace Assignment_1
{
    class assignment
    {
        ...
        {
            new Movie("Matrix Reloaded", "Action", "2003-05-30", 100000),
            new Movie("Marvel EndGame", "Comedy", "2021-06-01", 50000),
            new Movie("Guardians of Galaxy 3", "Drama", "2023-06-05", 75000),
